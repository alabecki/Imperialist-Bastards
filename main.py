...
while True:
	...
	print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! \n")
	print("########################################################################################################### \n")
	print(" ____________________________________ Main Menu ___________________________________________ \n")
	print("\n")
	print("____________________________Please select one of the following: _____________________________\n")
	print("---------------------------------- Start a New Game ---(S) --------------------------------------	 \n")
	...
	selection = " "
	while selection not in ["S", "L", "O", "E"]:
		selection = input()
