...
technology_dict = {
	...
	"pre_industry_2": {"requirement": {"pre_industry_1"}, "cost": 1.5, "min_mid": 0},
	"pre_industry_3": {"requirement": {"pre_industry_2"}, "cost": 1.5, "min_mid": 0},
	...
	"muzzle_loaded_arms": {"requirement": {"flint_lock"}, "cost": 1.5, "min_mid": 0},
