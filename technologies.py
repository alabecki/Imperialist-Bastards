...
technology_dict = {
	...
	"flint_lock": {"requirement": {"pre_industry_2"}, "cost": 1, "min_mid": 0},
	...
	"high_pressure_steam_engine": {"requirement": {"pre_industry_3"}, "cost": 1, "min_mid": 1},
	...
	"steel_plows": {"requirement": {"pre_industry_3"}, "cost": 2, "min_mid": 1},
	...
	"iron_clad": {"requirement": {"breach_loaded_arms", "compound_steam_engine"}, "cost": 5, "min_mid": 8},
	...
	"synthetic_dyes": {"requirement": {"chemistry", "fertlizer"}, "cost": 5, "min_mid": 8},					
	"fertlizer": {"requirement": {"chemistry"}, "cost": 5, "min_mid": 8},
	"dynamite": {"requirement": {"chemistry", "fertlizer"}, "cost": 5, "min_mid": 8},
	...
	"bombers": {"requirement": {"flight", "automoblie"}, "cost": 8, "min_mid": 16}, 
