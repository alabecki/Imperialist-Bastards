...
def create_provinces():
	...
	Siten = Province("Siten", "Bambaki", "coal", 1.2, "civilized", "Bambaki")
	Siten.x = 6
	Siten.y = 10
	...
	Fothra = Province("Fothra", "Hyle", "coal", 1.2, "civilized", "Hyle")
	Fothra.x = 2
	Fothra.y = 11
	Fothra.ocean = False
	...
	Eateven = Province("Eateven", "Trope", "coal", 1.2, "civilized", "Trope")
	Eateven.x = 8
	Eateven.y = 11
	Eateven.ocean = False
	...
	Sevfif = Province("Sevfif", "Isorropia", "coal", 1.2, "civilized", "Isorropia")
	Sevfif.x = 7
	Sevfif.y = 15
	...
	Sevteeve  = Province("Sevteeve", "Karbouno", "coal", 1.35, "civilized", "Karbouno")
	Sevteeve.x = 4
	Sevteeve.y = 14
	provinces["Sevteeve"] = Sevteeve 
	
	Fogaro = Province("Fogaro", "Karbouno", "coal", 1.3, "civilized", "Karbouno")
	Fogaro.x = 4
	Fogaro.y = 15
	...
	Tomski = Province("Tomski", "Intero", "gold", 1.1, "uncivilized", "Intero")
	Tomski.x = 5
	Tomski.y = 11
	Tomski.ocean = False
	...
	Irku = Province("Irku",  "Kora", "coal", 1.25, "uncivilized", "Kora")
	Irku.x = 3
	Irku.y = 14
	Irku.ocean = False
	provinces["Irku"] = Irku
	...
	Napa.y = 14
	provinces["Napa"] = Napa
	Lazo = Province("Lazo", "Cindra", "coal", 1.1, "civilized", "Cindra")
	Lazo.x = 7
	Lazo.y = 14
	provinces["Lazo"] = Lazo
